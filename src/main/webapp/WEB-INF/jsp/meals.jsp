...
<section>
    ...
    <hr/>
    <a href="<c:url value="/create?action=create"/>"><spring:message code="meal.addMeal"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="create?action=update&id=${meal.id}"><spring:message code="meal.update"/></a></td>
