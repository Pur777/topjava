...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void registerDuplicateMail() throws Exception {
        UserTo createdTo = new UserTo(null, "newName", "admin@gmail.com", "newPassword", 1500);
    ...
    @Test
    void registerIncorrectData() throws Exception {
        UserTo createdTo = new UserTo(null, "newName", "", "newPassword", 1500);
    ...
    @Test
    void updateIncorrectData() throws Exception {
