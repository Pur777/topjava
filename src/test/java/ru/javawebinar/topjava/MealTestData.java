...
public class MealTestData {
    ...
    public static final List<Meal> MEALS_TEST_DELETE = List.of(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2);
    public static final List<Meal> MEALS_TEST_BETWEEN = List.of(MEAL5, MEAL4, MEAL2, MEAL1);
    public static final List<MealTo> MEAL_TO = MealsUtil.getWithExcess(MEALS, MealsUtil.DEFAULT_CALORIES_PER_DAY);
    public static final List<MealTo> MEAL_TO_BETWEEN = MealsUtil.getWithExcess(MEALS_TEST_BETWEEN, MealsUtil.DEFAULT_CALORIES_PER_DAY);
